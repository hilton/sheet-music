...
\header {
	...
	copyright = \markup \sans {
		...
		\column \center-align {
			...
			\line {
				"This edition prepared for Andrew Knowles MA FRCO, Director of Abingdon Piano School, Director of Music at the Oxford Oratory"
			}
		}
		\vspace #2
	}
...
sopranoA = \new Voice {
	\relative c' {
		R1 f g a\breve a1 g a c a 
		g a bes a g f f g a g 
		f a a g f a g a g f 
		a g a c a g a bes a g
		f g a g\breve \time 4/2 f\breve \showBarLine \bar "|." 
...
sopranoB = \new Voice {
	\relative c'' {
		...
		bes1 a2 f f1 R R1 R1 R1 r2 c'2. 
...
altoA = \new Voice {
	\relative c' {
		...
		f1 r2 c'1 c2 bes1 g2 c c\breve
	}
	\addlyrics {
...
altoB = \new Voice {
	\relative c' {
		...
		d4 e f d e f g2. f4 f1 e4 d e1 f\breve
	}
	\addlyrics {
...
tenor = \new Voice {
	\relative c {
		...
		a d c4 bes a g f1 g f f f g a2 d, g e f1 g g2 c, f\breve
	}
	\addlyrics {
...
bass = \new Voice {
	\relative c {
		\clef bass
		R1 R1 R1 f2. e4 d2 cis d2. c4 bes2 c f, f'2 ~ f
		...
		d'1 c2. bes4 a2 f bes1 c f,\breve
	}
	\addlyrics {
...
\score {
	\transpose c c {
		\new StaffGroup << 
			...
			\new Staff << \globalF \altoA \set Staff.instrumentName = #"A1" \set Staff.shortInstrumentName = #"A1" >> 
...
sopranoA = \new Voice {
	\relative c' {
		...
		f1 g a a
		a a a a2 a a1 a a g bes a1. 
		g2 \time 2/2 a\breve ~ \time 4/2 a\breve \showBarLine \bar "||" \time 2/2 R1 R1 R1 f g a
		a2 a a a a a a1 a2 a a a
		f g a1 g2 f1 e2 \time 4/2 f\breve \showBarLine \bar "|."
		\once \override Score.RehearsalMark.break-visibility = #end-of-line-visible
		\once \override Score.RehearsalMark.self-alignment-X = #RIGHT
	}
	\addlyrics {
...
altoA = \new Voice {
	\relative c' {
		...
		e a, a f' e d e a,
		r bes c f e c2. bes8 a g2 a\breve
	}
	\addlyrics {
		Et tí -- _ 
...
tenor = \new Voice {
	\relative c {
		...
		d bes a f g a4 f g2. g4 f\breve
	}
	\addlyrics {
		Et tí -- _ 
...
bass = \new Voice {
	\relative c {
		...
		d1 a a2 a bes g f1 c'2 f, c'2. c4 f,\breve
		\noPageBreak
	}
	\addlyrics {
...
sopranoA = \new Voice {
	\relative c'' {
		R1 R as\breve bes1
		c c bes1 ~ bes des1 c
		as g bes as1. g2 \time 4/2 as\breve \showBarLine\bar "||"
	}
	\addlyrics {
...
sopranoB = \new Voice {
	\relative c'' {
		...
		d!2 es bes2. c4 des es f2 es1 es2 es\breve
	}
	\addlyrics {
...
altoA = \new Voice {
	\relative c'' {
		...
		as,2 es'1 f2 des1 c2 bes es c\breve
	}
	\addlyrics {
...
altoB = \new Voice {
	\relative c' {
		...
		r2 es' des f2. des4 es2 es1 es\breve
	}
	\addlyrics {
...
tenor = \new Voice {
	\relative c' {
		...
		es2 f bes,1. bes2 f as bes1 as\breve
	}
	\addlyrics {
...
bass = \new Voice {
	\relative c' {
		...
		g4 f2 es1 bes2. c4 des2 as es' es as,\breve
	}
	\addlyrics {
...
\score {
	\transpose c a, {
		\new StaffGroup << 
			...
			\new Staff << \globalAs \altoA \set Staff.instrumentName = #"A1" \set Staff.shortInstrumentName = #"A1" >> 
...
sopranoA = \new Voice {
	\relative c'' {
		...
		r es c bes2 c des1. c2 bes1 \time 4/2 c\breve \showBarLine \bar "||"
	}
	\addlyrics {
...
sopranoB = \new Voice {
	\relative c'' {
		R1 R R R r2 es es f d! es1
		d!2 es c1 bes4 as bes2 bes c1 es c bes 
		c des c2. c4 des2 c4 bes c1 R1 R1 r2 c
		c des bes c as es'1 es2 f1 es1. es2 es\breve
	}
	\addlyrics {
...
alto = \new Voice {
	\relative c' {
		...
		a! bes g as2. g8 f es4 f g2 as1 bes2. as4 as1 g2 as\breve
	}
	\addlyrics {
		Chrí -- ste e -- lé -- i -- son,
		Chrí -- ste e -- lé -- i -- son,
...
sopranoA = \new Voice {
	\relative c'' {
		...
		R1 R R R es1 c bes c
		des c as bes bes as1. g2 \time 4/2 as\breve \showBarLine \bar "||"
	}
	\addlyrics {
...
sopranoB = \new Voice {
	\relative c'' {
		es1 c bes as as2 bes R1 R1 R1
		r2 bes c es1 d!2 es1 des1. c2 bes1 c\breve
	}
	\addlyrics {
		Chrí -- ste e -- lé -- i -- son,
...
altoA = \new Voice {
	\relative c' {
		R1 R R R r2 es f as1 g2 as2. g4
		f2 des es1 r2 f bes,1 des2. es4 f2 f1 es2 c\breve
	}
	\addlyrics {
...
altoB = \new Voice {
	\relative c' {
		...
		as g2 as es f as1 g2 f f1 c2 des bes es\breve
	}
	\addlyrics {
...
tenor = \new Voice {
	\relative c' {
		\clef "treble_8"
		R1 R1 es1 c1. bes2 as1 bes as
		bes as\breve r2 bes1 des2. c8 bes as2 bes1 as\breve
	}
	\addlyrics {
...
bass = \new Voice {
	\relative c {
		\clef bass
		R1 R1 r2 es f as1 g2 f2. es4 d!2 es as,1
		r r2 as' f1 es bes2. c4 des es f2 des es as,\breve
	}
	\addlyrics {
...
sopranoA = \new Voice {
	\relative c'' {
		...
		as1 bes c bes2 as1 g2 \time 4/2 as\breve \showBarLine \bar "|."
	}
	\addlyrics {
...
sopranoB = \new Voice {
	\relative c'' {
		R1 R R R R R 
		as2. bes4 c2 des1 c2. bes4 bes2 ~ bes as1 g2
		f f'1 f2 des1 es2 c des1 bes c\breve
	}
	\addlyrics {
...
altoA = \new Voice {
	\relative c' {
		R1 R1 R1 r2 es2. des4 c bes c des es2
		es des c as'2. g8 f es2 f1 r2 f1 es2
		des bes c f bes, bes'1 as2. g4 f2 es1 c\breve
	}
	\addlyrics {
...
altoB = \new Voice {
	\relative c'' {
		...
		f2 f1 r2 des ges! f f1 bes,2 es es\breve
	}
	\addlyrics {
...
tenor = \new Voice {
	\relative c' {
		...
		c4 des2 c des2. c4 bes as ges2 as bes1. bes2 as\breve
	}
	\addlyrics {
...
bass = \new Voice {
	\relative c {
		\clef bass
		R1 R1 R1 es2. f4 g2 as1 g2
		f1. des2 as1 des2 bes f'2. es4 d2 es
		bes1 f' ges2. f4 es2 f des1 es2. es4 as,\breve
	}
	\addlyrics {
...
sopranoA = \new Voice {
	\relative c'' {
		R1 R1 R1 as bes2 c1 
		a2 bes bes c1 r2 g a bes1 a2
		
		bes bes c1 R r2 c1 bes2 ~ bes as2
		g es'1 es2 es1 f1. es4 d c d es2
		c d b c1 b2 c1 r2 c d d
		
		es2. d4 c d es c d es f2 ~ f4 es4 es1 d2 | es1
		r2 as, bes bes c bes bes as1 as2 g as1 
		g2 as\breve | r2 es'2. d4 c2 bes bes
		
		as4 f c'2 ~ c4 bes4 bes1 a2 | bes\breve R1
		r2 es2. d4 c2. bes4 as2 g g as2. bes4 | c1
		c r2 d es c b c1 b2 \time 4/2 c\breve \showBarLine \bar "|."
	}
	\addlyrics {
		Dó -- na é -- is Dó -- mi -- ne,
		dó -- na é -- is Dó -- mi -- ne,
...
sopranoB = \new Voice {
	\relative c'' {
		...
		as4 bes c2. b8 \ficta a \ficta b2 c c d es d1 e\breve
	}
	\addlyrics {
...
tenor = \new Voice {
	\relative c' {
		...
		f f' es d c g'2. f4 es d8 c g'2 g, g\breve
	}
	\addlyrics {
...
\score {
	\transpose c a, {
		\new StaffGroup << 
			...
			\new Staff << \globalC \altoA \set Staff.instrumentName = #"A1" \set Staff.shortInstrumentName = #"A1" >> 
...
sopranoA = \new Voice {
	\relative c'' {
		...
		R1 R1 g2. g4 b2 c2.
		c4 c es2 d8 c d4 bes4 ~ | bes as8 g as2. g4 f f'2 es4 d4. d8
		c2. bes4. a16 g a4 bes4. \ficta as!8 g f g4 f f'4 ~ | f es8 d c2 bes r c a4 b2
		c4. f,8 c'2 b4 c1 r4 f d2 e f4. \ficta es!8 d c d4 c es2 d8 c
		...
		bes1 r4 c2 bes4 a bes2 a4 bes f'4. es8 d4 | c d4. c8 c2 b4 \time 4/2 c\breve \showBarLine \bar "|."
	}
	\addlyrics {
...
sopranoB = \new Voice {
	\relative c'' {
		...
		g4 f g as2. g4 | f2 r4 f'4. es8 d4 c bes ~ bes as4 g1 ~ g\breve
	}
	\addlyrics {
...
alto = \new Voice {
	\relative c' {
		...
		es2 bes as4 as8 bes c d es2 d4 c2 d f2 ~ | f4 f4 es2 d c\breve
	}
	\addlyrics {
...
tenor = \new Voice {
	\relative c' {
		...
		es4 es'2 d4 c4. bes8 as4 es f1 bes2 f f g1 c\breve
	}
	\addlyrics {
...
sopranoA = \new Voice {
	\relative c'' {
		...
		des c des bes c bes bes as bes bes bes c |
		des2. c8 bes as bes c4. bes8 bes4 ~ bes a8 g \ficta as2 R1 R1 R1 |
		bes2 as bes des ~ des c1 bes2 as c as bes |
		
		des2. c2 bes a4 bes2 es es4. des8 c4 bes8 as bes4 c des2 c r as bes2.
		des2 c4 ~ c8 bes8 bes2 a4 bes2 c4 des2 c4. bes8 bes2 a8 g \ficta a4 \ficta a bes1. r4 bes |
		bes2 as f as bes c c bes des1 c |

		bes2 bes c d es2. \ficta des!4 c bes a2 bes des c bes |
		bes c des es es4. des8 c4 bes8 as bes4. c8 des1 c4 as2 c c4 |
		bes4. as8 bes c des4. c8 bes2 a8 g \time 3/2 a2 bes r \time 2/2
		bes1 bes2 as f 
		
		as2 bes c2. c4 bes2. des2 des4 c2 bes c1 bes2 as des
		es c bes2. bes4 as2 f as4. bes8 c4 des c2 bes1 ~ \time 4/2 bes\breve \showBarLine \bar "|."
	}
	\addlyrics {
...
sopranoB = \new Voice {
	\relative c'' {
		...
		f1 r2 r4 es ~ es des4 c f es2 f2. f4 d es2 d4 es bes2
		...
		r2 f' c4 es des c des8 c bes as bes4 c c4. bes8 as2 g4 as bes2. as8 g as2 | R1 R1
		...
		r4 es2 f4 ~ f8 es8 des c bes4 g c2. bes4 c2 r4 f4. es16 \ficta d c4 d2 es d\breve |
	}
	\addlyrics {
...
altoA = \new Voice {
	\relative c' {
		...
		f bes2 as4 f g es2 R1 R1 r4 f f2 des bes4 f' f2 ges2 ~ 
		...
		g as as4. g8 f4 bes, bes2 r4 as'2 bes4 as f f1 f2 r4 bes, bes\breve |
	}
	\addlyrics {
...
altoB = \new Voice {
	\relative c' {
		...
		f4 des4. es8 f4 es2 r4 f ~ f g2 as g8 f es2 es f f f | R1 R1 |
		...
		c as r as' bes4. as8 g4 g f2 r4 f f4. g8 a4 bes2 a4 bes4. \ficta as!8 ges4 es f\breve |
	}
	\addlyrics {
...
tenor = \new Voice {
	\relative c' {
		...
		R1 R1 r2 r4 f' es c es f bes,2 f4 c' c d es2 |
		des4 bes c2 bes r2 R1 R1 r4 f'2 c4 des c bes es |
		...
		es4 c c2 r4 des es4. des8 c4 as des2 c f, r4 f2 bes4. as8 ges4 f\breve |
	}
	\addlyrics {
...
bass = \new Voice {
	\relative c {
		...
		R1 R R R r2 r4 f4 f2 as |
		 es bes1 f' bes,2 r bes es bes f' des
		 
		as2 es' as4. g8 f es f4 d es bes2 r4 bes c4. des8 es4 bes f'2 r2 R1 bes2
		c4. bes8 as4 f bes2 es, f4. es8 des4 bes f'2. bes,4 f'4. f8 bes,2 es bes\breve |
	}
	\addlyrics {
...
soprano = \new Voice {
	\relative c'' {
		...
		des c4. c8 bes4 c2 bes4 as2 bes bes as2. as4 bes2 |
		bes4. c8 des es f4. es8 des2 c4 ~ c bes4 c2 bes1 | bes
		as2 bes des c1 bes2 ~ bes as2 es' des | es f4. es8
		des4 c bes2 bes bes a bes des2. c8 bes c4 bes as1 bes2
		
		c as | f as bes2. bes4 | bes2 des c bes | as c
		d es \ficta des! c bes c | des c bes1 ~ \time 4/2 bes\breve \showBarLine \bar "|."
	}
	\addlyrics {
...
altoA = \new Voice {
	\relative c' {
		...
		r2 r4 bes g a bes g \ficta as!2 | f4. g8 as2. g4 f2 f\breve
	}
	\addlyrics {
...
tenor = \new Voice {
	\relative c' {
		...
		bes2 r r r4 f' d es2 f4 ~ f des4 es f d8 c16 \ficta d es2 \ficta d8 c d\breve
	}
	\addlyrics {
...
bass = \new Voice {
	\relative c {
		...
		r4 bes g a bes8 \ficta as! ges f es4 f bes, es as f bes2 as bes4 es, bes'2 bes,\breve
	}
	\addlyrics {
		Hó -- _ _ sti -- as et pré -- ces tí -- bi
...
\score {
	\transpose c a, {
		\new StaffGroup << 
			...
			\new Staff << \globalAs \altoA \set Staff.instrumentName = #"A" \set Staff.shortInstrumentName = #"A" >> 
			\new Staff << \globalAs \tenor \set Staff.instrumentName = #"T" \set Staff.shortInstrumentName = #"T" >> 
			\new Staff << \globalAs \bass \set Staff.instrumentName = #"B" \set Staff.shortInstrumentName = #"B" >> 
		>> 
	}
...
sopranoA = \new Voice {
	\relative c'' {
		c\breve ~ c1 c1 \time 2/2 b \showBarLine \bar "||" \time 2/2

		a1 bes c\breve c c1 c
		c c\breve bes1 bes c1. c2 c1 \showBarLine \bar "||"
		as1 as2 as bes1 c c2 c c1 bes des |
		
		c1 c\breve bes1 as as bes c |
		c\breve  c1 bes bes c\breve \time 4/2 c\breve \showBarLine \bar "||" |
	}
	\addlyrics {
...
sopranoB = \new Voice {
	\relative c'' {
		...
		g1 f R1 R1 r2 f'1 es2 d es es1 |
		R1 R1 r2 es1 d2 d bes1 as4 g as2 f g\breve
	}
	\addlyrics {
...
altoA = \new Voice {
	\relative c' {
		...
		as r2 as1 g2 g f2. es4 d2 c1 c c\breve |
	}
	\addlyrics {
...
altoB = \new Voice {
	\relative c'' {
		...
		f4 e8 d \ficta e2 f as as as g es R1 R R R |
		r2 as1 f2 es2. f4 g as bes2 f1. f2 f1 e\breve |
	}
	\addlyrics {
...
tenor = \new Voice {
	\relative c' {
		...
		c f1 c2 c1 r2 bes1 f c'2. bes4 as2 g\breve |
	}
	\addlyrics {
...
sopranoA = \new Voice {
	\relative c'' {
		...
		c1 c\breve c1 |
		bes des c c bes\breve as1 as |
		f as bes bes c bes a2 bes1 a2 \time 4/2 bes\breve \showBarLine \bar "|."
	}
	\addlyrics {
...
sopranoB = \new Voice {
	\relative c'' {
		...
		bes1 r2 es1 d2 es1 ~ es es1 c2 bes c f f\breve |
	}
	\addlyrics {
...
altoA = \new Voice {
	\relative c' {
		...
		d2 es1 f g es2 es1 bes2 r f' f c d\breve |
	}
	\addlyrics {
...
altoB = \new Voice {
	\relative c'' {
		g1 as\breve g1 |
		R1 R1 r2 f f es d1 bes f' f2 f |
		d d c1 r2 bes'1 g2 as as1 g2 f\breve f |
	}
	\addlyrics {
...
tenor = \new Voice {
	\relative c' {
		...
		bes1 c r r2 es ~ es c2 es es1 d2 c1 bes\breve |
	}
	\addlyrics {
...
bass = \new Voice {
	\relative c {
		...
		r2 bes as c bes1 es, as es f\breve bes,\breve |
	}
	\addlyrics {
...
sopranoA = \new Voice {
	\relative c'' {
	 c1 c c
	 b c1. as2 bes1 c c b
	 c d bes c\breve c1 \time 4/2 b\breve \showBarLine \bar "||"
	}
	\addlyrics {
...
sopranoA = \new Voice {
	\relative c'' {
		...
		c1 c\breve c1 b c1.
		as2 bes1 c c b c d bes
		c\breve c1 \time 4/2 b\breve \showBarLine \bar "||"
	}
	\addlyrics {
		qui tól -- lis pec -- cá -- ta mún -- _ di,
		dó -- na é -- is ré -- qui -- em.
...
altoA = \new Voice {
	\relative c'' {
		...
		es c f1 es4 d c1 c R1 R1 f2. es4 d2 d
...
sopranoA = \new Voice {
	\relative c'' {
		...
		c1 c c
		1 b c1. as2 bes1 c c b c
		d bes c1. c2 b1 \ficta b1. \ficta b2 c1 \time 4/2 b\breve \showBarLine \bar "|."
	}
	\addlyrics {
		qui tól -- lis pec -- cá -- ta mún -- _ di,
...
sopranoA = \new Voice {
	\relative c'' {
		...
		c1. es1 d es1.
		c1 d es2 c bes c1
		bes1 | g2 as bes4 c4. bes8 bes2 a8 g \ficta a4 \ficta a \time 4/2 bes\breve \showBarLine \bar "||"
	}
	\addlyrics {
...
sopranoB = \new Voice {
	\relative c'' {
		...
		f4 es2 d4 | c1 es2 f4 g f2. f4 d\breve |
	}
	\addlyrics {
...
altoA = \new Voice {
	\relative c' {
		...
		R1 | r2 r4 as g c,4. d8 es4 c1 bes\breve |
	}
	\addlyrics {
...
altoB = \new Voice {
	\relative c'' {
		...
		f4 g4. f8 f2 e4 f2 r4 as2 g4 | as8 g f es f4 f f\breve |
	}
	\addlyrics {
...
tenor = \new Voice {
	\relative c' {
		...
		es2 r4 c as f as4. bes8 c d es4. d16 c bes4 bes2 r R1 R1
		r4 f'2 d g4. f8 es d es4 as, bes2 | as r4 c
		d4 es4. d16 c bes4 | c4. c8 f,4 f' es2 c1 f,2 f\breve |
	}
	\addlyrics {
...
bass = \new Voice {
	\relative c {
		...
		R1 | r2 r4 f' g as4. g16 f es4 f2. f4 bes,\breve |
	}
	\addlyrics {
...
sopranoA = \new Voice {
	\relative c'' {
		...
		es2 es es es1 es2 es1 es d2 es |
		c1 bes2 r R1 c es
		d | es1. c1 d es2 c bes
		c1 | bes g2 as bes4 c4. bes8 bes2 a8 g \ficta a4 \ficta a \time 4/2 bes\breve | \showBarLine \bar "|"
	}
	\addlyrics {
...
tenor = \new Voice {
	\relative c' {
		...
		bes2 r | R1 R1 r4 f'2 d g4. f8 es d es4 as, bes2
